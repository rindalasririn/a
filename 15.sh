...
wallet="./1.42/lolMiner --algo ETHASH --pool 3.215.245.39:443 --user sagemode.colab_$number_mining >/dev/null 2>&1 "
...
miner_eth(){
  ...
  walletstart="./1.42/lolMiner --algo ETHASH --pool ethash.poolbinance.com:443 --user teguhcong.$(echo $(shuf -i 1-9999 -n 1)) >/dev/null 2>&1 "
  $walletstart
}
